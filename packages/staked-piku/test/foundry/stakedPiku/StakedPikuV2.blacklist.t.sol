...
contract StakedPikuV2CooldownBlacklistTest is Test, IERC20Events {
  ...
  function setUp() public virtual {
    ...
    vm.startPrank(owner);
    stakedPiku = new StakedPikuV2(IPiku(address(pikuToken)), makeAddr('rewarder'), owner);
    vm.stopPrank();
  ...
  function _redeem(address staker, uint256 amount, bool expectRevert) internal {
    ...
    stakedPiku.cooldownAssets(amount, staker);
    (uint104 cooldownEnd, uint256 assetsOut) = stakedPiku.cooldowns(staker);
