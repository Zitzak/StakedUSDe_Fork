...
contract StakedUSDe is SingleAdminAccessControl, ReentrancyGuard, ERC20MultiVotes, ERC4626, IStakedUSDe {
  ...
  /// @dev Necessary because both SingleAdminAccessControl and Ownable declare owner()
  function owner() public view override(SingleAdminAccessControl, Ownable) returns (address) {
  ...
  /* ------------- ERC20MultiVotes overrides ------------- */

  function _burn(address account, uint256 amount) internal override( ERC20MultiVotes, ERC20) {
        super._burn(account, amount);
  }

  function transfer(address to, uint256 amount) public override(ERC20MultiVotes, ERC20, IERC20) returns (bool) {
        return super.transfer(to, amount);
  }

  function transferFrom(address from, address to, uint256 amount) public override(ERC20MultiVotes, ERC20, IERC20) returns (bool) {
